...
print(cnt - 1, max_dist)    # 시작 노드 제외

'''
회고 / TIL
- 개선된 다익스트라 알고리즘이 아직 익숙치 않았기 때문에, 앞서 작성한 다익스트라 부분의 코드만 참고해서 풀었음. 
- 이 문제는 몇 개의 도시까지 도달할 수 있는지 카운트하고, 도달할 수 있는 도시 중 가장 멀리 있는 도시는 얼마나 걸리는지를 출력하는 것이 포인트임. 
- 최종적으로 카운트를 출력할 때 출발 도시는 빼주고 시작해야 함. 
'''